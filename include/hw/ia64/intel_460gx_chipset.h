...
#define INTEL_460GX_CHIPSET_MEMORY_CARD_A       0x05
#define INTEL_460GX_CHIPSET_MEMORY_CARD_B       0x06
...
#define INTEL_460GX_CHIPSET_FIXED_PRESENT_MASK \
    (BIT(INTEL_460GX_CHIPSET_SAC_DEVICE) |      \
     ...
     BIT(INTEL_460GX_CHIPSET_MEMORY_CARD_A) |   \
     BIT(INTEL_460GX_CHIPSET_MEMORY_CARD_B))
